...
# Establece un criterio para la asignación de los recursos y genera las órdenes para mañana
  # Objetivo 3.1: Calcula el órden en el que los activos recibirán el capital disponible
  # Objetivo 3.2: Genera la recomendación para mañana

options(scipen=999, digits = 6) 
options(warn=-1)
options(java.parameters = "-Xmx8000m") 
source('Ejercicio 3.1 funciones auxiliares.R', encoding="UTF-8") 
...
###########################################################################################################################################
  ...
  # activos_seleccionados<-seleccion_activos(datos_descargados, ventana, entrada, salida, percentil_dinamico, fecha_inicio)
    # save(activos_seleccionados, file = "activos_seleccionados.RData")
    load("activos_seleccionados.RData")
